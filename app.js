...
async function shareShadowOpsApp(){
  const shareData = {
    ...
    url: "https://scorpionbz.github.io/Shadow-Ops-global/"
  };
  ...
  if (navigator.share) {
    ...
    try {
      ...
      alert("Enlace copiado: " + shareData.url);
    } catch (err) {
      prompt("Copia el enlace de la app:", shareData.url);
    }
  }
}

const shareBtn = document.getElementById("shareBtn");
if(shareBtn) shareBtn.addEventListener("click", shareShadowOpsApp);

const shareRecruitBtn = document.getElementById("shareRecruitBtn");
if(shareRecruitBtn) shareRecruitBtn.addEventListener("click", shareShadowOpsApp);
