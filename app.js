...
let members = {}, requests = {}, news = {}, profiles = {}, mvp = {name:"Por definir", region:"Global", reason:"Seleccionado por ScorpionBz"};
...
function renderAll(){ renderStats(); renderMembers(); renderRanking(); renderNews(); renderMvp(); renderRequests(); renderRegions(); renderVipProfiles(); renderAdminMembers(); }
